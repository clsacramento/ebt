...
Ce système implique l'utilisation de complexes algorithmes de calcul de route qui doivent s'exécuter dans chaque nœud à chaque changement d'état et également le traitement des bouclages de diffusion entre les voisins. 
