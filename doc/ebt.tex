...
{
  name=Open Source,
  description={ Logiciel avec code source ouvert...  }
}

\newglossaryentry{opendaylight}
{
  name=Open Daylight,
  description={ Association provoqué par Linux Foundation pour l'union des géants du marché réseau dans le but de développer un contrôleur SDN open source  }
}
