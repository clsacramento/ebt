...
\newglossaryentry{fabric}
{
  ...
  Sous ce terme généralement admis par l'industrie réseau, un fabric est une topologie réseau dans laquelle les composants transmettent des données un à l'autre  à travers les switches d’interconnexion.
