...
\hrulefill
\begin{abstract}
Résumé en français \ldots

\bigskip\noindent
Mots clés : SDN, Réseaux Programmables, Plan de Contrôle, Plan de Données, Système d'Exploitation Réseau
\end{abstract}

\hrulefill
\selectlanguage{english}
\begin{abstract}
Résumé en anglais \ldots

\bigskip\noindent
Keywords : SDN, Programmable Networks, Control Plane, Data Plane, Network Operating System
\end{abstract}
