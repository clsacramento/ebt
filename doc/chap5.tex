...
\caption{ Arhitecture OpenFlow SDN par ONF \cite{SDNNewNormONFExecutiveSummary}} %la légende
...
\hline 
Outils pour la réalisation de tets, les propres résultats des tests & QualiSystems, inCNTRE, Ixia, Spirent \\ 
\hline 
Standards et protocoles & ONF, IEEE, IETF \\ 
\hline 
Controôleur SDN & Big Szitch Networks, NEC, Nuage Networks, Netsocket, HP, Cisco, Open Daylight Consortium, VMware/Nicira \\ 
\hline 
