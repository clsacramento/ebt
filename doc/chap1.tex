...
\par
En réponse à ces questions, des composants \glspl{middlebox} ont été introduits dans l'architecture, par exemple les \glslink{nat}{NATs} et les pare-feu, en ajoutant ainsi une nouvelle contrainte : la complexité. Dans ces systèmes, le logiciel 
...
Internet est vu aujourd'hui comme une infrastructure critique de la société, tels que le transport et l'électricité.  Cela provoque une résistance face aux tentatives de déploiement de nouvelles applications en parallèle à celles en mode de production. 
...
\section{Gestion du Réseau : Contraignante et Complexe}
...
Le besoin  des services réseau et de haut-débit augmentent à un taux plus rapide que la disponibilité des moyens, comme on peut le visualiser dans la figure \ref{imgPressure}.
