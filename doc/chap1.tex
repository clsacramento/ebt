...
En résumé, l'infrastructure réseau confronte actuellement aux challenges suivants :
\begin{itemize}
\item La sécurité : la manque de sécurité est assez inquiétante à tout niveau : des utilisateurs, aux développeurs aux opérateurs de services.
